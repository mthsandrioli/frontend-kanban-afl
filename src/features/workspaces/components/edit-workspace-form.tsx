...
export const EditWorkspaceForm = ({
  ...
  const [ResetDialog, confirmReset] = useConfirm(
    ...
    "Esta ação vai invalidar o link de convite atual",
    "destructive"
  );
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Nome do espaço de trabalho" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
      ...
      <Card className="w-full h-full border-none shadow-none">
        <CardContent className="p-7">
          <div className="flex flex-col">
            ...
            <p className="text-sm text-muted-foreground">
              Use o link de convite para adicionar membros ao seu espaço de trabalho.
            </p>
            <div className="mt-4">
      ...
      <Card className="w-full h-full border-none shadow-none">
        <CardContent className="p-7">
          <div className="flex flex-col">
            ...
            <p className="text-sm text-muted-foreground">
              A exclusão de um espaço de trabalho é irreversível e removerá todos
              dados associados.
            </p>
            <DottedSeparator className="py-7" />
            <Button
